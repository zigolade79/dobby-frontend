    ...
    <header className="py-4">
      <div className="w-full px-5 xl:px-10 mx-auto max-w-screen-xl flex justify-between">
        <div className="flex justify-between items-center">
          <div>
            <a href="/"> <img src={podcastLogo} className="max-h-12 max-w-20" /></a>
          </div>
        </div>
        <div className="flex justify-between items-center">
          <span>
            {!isLoggedIn && <a className="hover:underline mx-5" href="/create-account">Sign in</a>}
          </span>
          <span>
            {!isLoggedIn && <a className="hover:underline mx-5" href="/login">Log in</a>}
          </span>
          <span>
